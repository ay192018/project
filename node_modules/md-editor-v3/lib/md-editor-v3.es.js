...
import { onMounted, onBeforeUnmount, provide, computed, reactive, watch, ref, defineComponent, createVNode, cloneVNode, nextTick, inject, Fragment, toRef, isVNode } from "vue";
const prefix = "md";
...
const Editor = defineComponent({
  ...
  setup(props, context) {
    ...
    return () => {
      ...
      }, null), catalogShow.value && !props.previewOnly && createVNode(MdCatalog, {
        "theme": props.theme,
        "style": {
