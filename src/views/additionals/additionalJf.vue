<template>
  <div>
    <div class="handle-box">
      ...
      >
        <el-option key="id" label="用户ID" value="U_ID"></el-option>
    ...
    >
      ...
      <el-table-column prop="Addtime" label="追加时间"></el-table-column>
      <el-table-column label="追加积分" prop="Integral" align="center">
      </el-table-column>
...
import { integralRecords } from "../../utils/table"
